<template>
    <div class="scheduler-list">
        ...
        <UpdateScheduler :scheduler="scheduler"></UpdateScheduler>
        </div>
</template>
 ...
 export default {
     ...
     methods: {
         ...
         startScheduler: function(event) {
             this.$http.post(api.scheduler_status, {
                 headers: {
         ...
         stopScheduler: function(event) {
             this.$http.delete(api.scheduler_status, {
                 headers: {
                     "Content-Type": 'application/json',
                 }
             })
